...
```bash
mkdir -p ~/.claude/skills/job-change-watchlist && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/job-change-watchlist/SKILL.md -o ~/.claude/skills/job-change-watchlist/SKILL.md && echo "Installed job-change-watchlist. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/job-change-watchlist/`, then restart Claude Code.
