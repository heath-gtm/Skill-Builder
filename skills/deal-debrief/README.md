...
```bash
mkdir -p ~/.claude/skills/deal-debrief && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/deal-debrief/SKILL.md -o ~/.claude/skills/deal-debrief/SKILL.md && echo "Installed deal-debrief. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/deal-debrief/`, then restart Claude Code.
