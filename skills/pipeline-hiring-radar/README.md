...
```bash
mkdir -p ~/.claude/skills/pipeline-hiring-radar && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/pipeline-hiring-radar/SKILL.md -o ~/.claude/skills/pipeline-hiring-radar/SKILL.md && echo "Installed pipeline-hiring-radar. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/pipeline-hiring-radar/`, then restart Claude Code.
