...
```bash
mkdir -p ~/.claude/skills/gtm-planning && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/gtm-planning/SKILL.md -o ~/.claude/skills/gtm-planning/SKILL.md && echo "Installed gtm-planning. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/gtm-planning/`, then restart Claude Code.
