...
```bash
mkdir -p ~/.claude/skills/pr-outreach && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/pr-outreach/SKILL.md -o ~/.claude/skills/pr-outreach/SKILL.md && echo "Installed pr-outreach. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/pr-outreach/`, then restart Claude Code.
