...
```bash
mkdir -p ~/.claude/skills/humanize-draft && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/humanize-draft/SKILL.md -o ~/.claude/skills/humanize-draft/SKILL.md && echo "Installed humanize-draft. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/humanize-draft/`, then restart Claude Code.
