...
```bash
mkdir -p ~/.claude/skills/cold-call-opener && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/cold-call-opener/SKILL.md -o ~/.claude/skills/cold-call-opener/SKILL.md && echo "Installed cold-call-opener. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/cold-call-opener/`, then restart Claude Code.
