...
```bash
mkdir -p ~/.claude/skills/daily-sales-assistant && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/daily-sales-assistant/SKILL.md -o ~/.claude/skills/daily-sales-assistant/SKILL.md && echo "Installed daily-sales-assistant. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/daily-sales-assistant/`, then restart Claude Code.
