...
```bash
mkdir -p ~/.claude/skills/funnel-metrics && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/funnel-metrics/SKILL.md -o ~/.claude/skills/funnel-metrics/SKILL.md && echo "Installed funnel-metrics. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/funnel-metrics/`, then restart Claude Code.
