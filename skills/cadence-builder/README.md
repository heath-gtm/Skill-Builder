...
```bash
mkdir -p ~/.claude/skills/cadence-builder && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/cadence-builder/SKILL.md -o ~/.claude/skills/cadence-builder/SKILL.md && echo "Installed cadence-builder. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/cadence-builder/`, then restart Claude Code.
