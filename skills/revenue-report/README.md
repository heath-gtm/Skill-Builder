...
```bash
mkdir -p ~/.claude/skills/revenue-report && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/revenue-report/SKILL.md -o ~/.claude/skills/revenue-report/SKILL.md && echo "Installed revenue-report. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/revenue-report/`, then restart Claude Code.
