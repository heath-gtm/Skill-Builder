...
```bash
mkdir -p ~/.claude/skills/landing-page-cro && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/landing-page-cro/SKILL.md -o ~/.claude/skills/landing-page-cro/SKILL.md && echo "Installed landing-page-cro. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/landing-page-cro/`, then restart Claude Code.
