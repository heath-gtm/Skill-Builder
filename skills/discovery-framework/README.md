...
```bash
mkdir -p ~/.claude/skills/discovery-framework && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/discovery-framework/SKILL.md -o ~/.claude/skills/discovery-framework/SKILL.md && echo "Installed discovery-framework. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/discovery-framework/`, then restart Claude Code.
