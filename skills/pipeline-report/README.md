...
```bash
mkdir -p ~/.claude/skills/pipeline-report && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/pipeline-report/SKILL.md -o ~/.claude/skills/pipeline-report/SKILL.md && echo "Installed pipeline-report. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/pipeline-report/`, then restart Claude Code.
