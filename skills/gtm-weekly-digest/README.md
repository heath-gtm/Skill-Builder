...
```bash
mkdir -p ~/.claude/skills/gtm-weekly-digest && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/gtm-weekly-digest/SKILL.md -o ~/.claude/skills/gtm-weekly-digest/SKILL.md && echo "Installed gtm-weekly-digest. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/gtm-weekly-digest/`, then restart Claude Code.
