...
```bash
mkdir -p ~/.claude/skills/sequence-performance-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/sequence-performance-analyst/SKILL.md -o ~/.claude/skills/sequence-performance-analyst/SKILL.md && echo "Installed sequence-performance-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/sequence-performance-analyst/`, then restart Claude Code.
