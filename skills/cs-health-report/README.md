...
```bash
mkdir -p ~/.claude/skills/cs-health-report && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/cs-health-report/SKILL.md -o ~/.claude/skills/cs-health-report/SKILL.md && echo "Installed cs-health-report. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/cs-health-report/`, then restart Claude Code.
