...
```bash
mkdir -p ~/.claude/skills/closed-won-analysis && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/closed-won-analysis/SKILL.md -o ~/.claude/skills/closed-won-analysis/SKILL.md && echo "Installed closed-won-analysis. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/closed-won-analysis/`, then restart Claude Code.
