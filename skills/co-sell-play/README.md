...
```bash
mkdir -p ~/.claude/skills/co-sell-play && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/co-sell-play/SKILL.md -o ~/.claude/skills/co-sell-play/SKILL.md && echo "Installed co-sell-play. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/co-sell-play/`, then restart Claude Code.
