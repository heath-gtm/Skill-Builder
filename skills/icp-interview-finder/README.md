...
```bash
mkdir -p ~/.claude/skills/icp-interview-finder && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/icp-interview-finder/SKILL.md -o ~/.claude/skills/icp-interview-finder/SKILL.md && echo "Installed icp-interview-finder. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/icp-interview-finder/`, then restart Claude Code.
