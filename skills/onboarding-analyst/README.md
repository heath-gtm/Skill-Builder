...
```bash
mkdir -p ~/.claude/skills/onboarding-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/onboarding-analyst/SKILL.md -o ~/.claude/skills/onboarding-analyst/SKILL.md && echo "Installed onboarding-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/onboarding-analyst/`, then restart Claude Code.
