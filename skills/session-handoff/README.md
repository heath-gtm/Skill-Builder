...
```bash
mkdir -p ~/.claude/skills/session-handoff && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/session-handoff/SKILL.md -o ~/.claude/skills/session-handoff/SKILL.md && echo "Installed session-handoff. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/session-handoff/`, then restart Claude Code.
