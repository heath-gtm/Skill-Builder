...
```bash
mkdir -p ~/.claude/skills/deal-intelligence && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/deal-intelligence/SKILL.md -o ~/.claude/skills/deal-intelligence/SKILL.md && echo "Installed deal-intelligence. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/deal-intelligence/`, then restart Claude Code.
