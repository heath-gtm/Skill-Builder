...
```bash
mkdir -p ~/.claude/skills/outbound-list-builder && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/outbound-list-builder/SKILL.md -o ~/.claude/skills/outbound-list-builder/SKILL.md && echo "Installed outbound-list-builder. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/outbound-list-builder/`, then restart Claude Code.
