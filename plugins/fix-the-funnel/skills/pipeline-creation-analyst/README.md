...
```bash
mkdir -p ~/.claude/skills/pipeline-creation-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/pipeline-creation-analyst/SKILL.md -o ~/.claude/skills/pipeline-creation-analyst/SKILL.md && echo "Installed pipeline-creation-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/pipeline-creation-analyst/`, then restart Claude Code.
