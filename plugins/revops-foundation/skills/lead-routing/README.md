...
```bash
mkdir -p ~/.claude/skills/lead-routing && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/lead-routing/SKILL.md -o ~/.claude/skills/lead-routing/SKILL.md && echo "Installed lead-routing. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/lead-routing/`, then restart Claude Code.
