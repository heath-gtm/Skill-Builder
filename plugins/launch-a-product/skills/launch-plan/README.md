...
```bash
mkdir -p ~/.claude/skills/launch-plan && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/launch-plan/SKILL.md -o ~/.claude/skills/launch-plan/SKILL.md && echo "Installed launch-plan. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/launch-plan/`, then restart Claude Code.
