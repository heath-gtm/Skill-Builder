...
```bash
mkdir -p ~/.claude/skills/trigger-outreach && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/trigger-outreach/SKILL.md -o ~/.claude/skills/trigger-outreach/SKILL.md && echo "Installed trigger-outreach. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/trigger-outreach/`, then restart Claude Code.
