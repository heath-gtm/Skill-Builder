...
```bash
mkdir -p ~/.claude/skills/coaching-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/coaching-analyst/SKILL.md -o ~/.claude/skills/coaching-analyst/SKILL.md && echo "Installed coaching-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/coaching-analyst/`, then restart Claude Code.
