...
```bash
mkdir -p ~/.claude/skills/business-case && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/business-case/SKILL.md -o ~/.claude/skills/business-case/SKILL.md && echo "Installed business-case. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/business-case/`, then restart Claude Code.
