...
```bash
mkdir -p ~/.claude/skills/crm-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/crm-analyst/SKILL.md -o ~/.claude/skills/crm-analyst/SKILL.md && echo "Installed crm-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/crm-analyst/`, then restart Claude Code.
