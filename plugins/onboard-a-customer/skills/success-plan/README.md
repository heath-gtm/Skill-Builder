...
```bash
mkdir -p ~/.claude/skills/success-plan && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/success-plan/SKILL.md -o ~/.claude/skills/success-plan/SKILL.md && echo "Installed success-plan. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/success-plan/`, then restart Claude Code.
