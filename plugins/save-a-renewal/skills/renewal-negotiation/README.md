...
```bash
mkdir -p ~/.claude/skills/renewal-negotiation && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/renewal-negotiation/SKILL.md -o ~/.claude/skills/renewal-negotiation/SKILL.md && echo "Installed renewal-negotiation. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/renewal-negotiation/`, then restart Claude Code.
