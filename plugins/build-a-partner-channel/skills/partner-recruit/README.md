...
```bash
mkdir -p ~/.claude/skills/partner-recruit && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/partner-recruit/SKILL.md -o ~/.claude/skills/partner-recruit/SKILL.md && echo "Installed partner-recruit. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/partner-recruit/`, then restart Claude Code.
