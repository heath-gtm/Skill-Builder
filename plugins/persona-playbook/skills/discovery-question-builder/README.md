...
```bash
mkdir -p ~/.claude/skills/discovery-question-builder && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/discovery-question-builder/SKILL.md -o ~/.claude/skills/discovery-question-builder/SKILL.md && echo "Installed discovery-question-builder. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/discovery-question-builder/`, then restart Claude Code.
