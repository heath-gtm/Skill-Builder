...
```bash
mkdir -p ~/.claude/skills/context-pack && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/context-pack/SKILL.md -o ~/.claude/skills/context-pack/SKILL.md && echo "Installed context-pack. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/context-pack/`, then restart Claude Code.
