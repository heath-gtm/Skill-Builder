...
```bash
mkdir -p ~/.claude/skills/content-brief && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/content-brief/SKILL.md -o ~/.claude/skills/content-brief/SKILL.md && echo "Installed content-brief. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/content-brief/`, then restart Claude Code.
