...
```bash
mkdir -p ~/.claude/skills/icp-scoring && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/icp-scoring/SKILL.md -o ~/.claude/skills/icp-scoring/SKILL.md && echo "Installed icp-scoring. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/icp-scoring/`, then restart Claude Code.
