...
```bash
mkdir -p ~/.claude/skills/keep-the-judgment && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/keep-the-judgment/SKILL.md -o ~/.claude/skills/keep-the-judgment/SKILL.md && echo "Installed keep-the-judgment. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/keep-the-judgment/`, then restart Claude Code.
