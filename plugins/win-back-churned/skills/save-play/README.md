...
```bash
mkdir -p ~/.claude/skills/save-play && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/save-play/SKILL.md -o ~/.claude/skills/save-play/SKILL.md && echo "Installed save-play. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/save-play/`, then restart Claude Code.
