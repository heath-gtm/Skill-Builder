...
```bash
mkdir -p ~/.claude/skills/product-usage-analyst && curl -fsSL https://raw.githubusercontent.com/heath-gtm/Skill-Builder/main/skills/product-usage-analyst/SKILL.md -o ~/.claude/skills/product-usage-analyst/SKILL.md && echo "Installed product-usage-analyst. Restart Claude Code."
```

Or download `SKILL.md` from this folder and drop it into `~/.claude/skills/product-usage-analyst/`, then restart Claude Code.
